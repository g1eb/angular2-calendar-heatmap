"use strict"
var __decorate=this&&this.__decorate||function(t,e,n,i){var a,r=arguments.length,o=r<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,n):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,n,i)
else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(o=(r<3?a(o):r>3?a(e,n,o):a(e,n))||o)
return r>3&&o&&Object.defineProperty(e,n,o),o},__metadata=this&&this.__metadata||function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}
Object.defineProperty(exports,"__esModule",{value:!0})
var core_1=require("@angular/core"),CalendarHeatmap=function(){function t(){this.color="#ff4500",this.overview="year",this.handler=new core_1.EventEmitter,this.gutter=5,this.item_gutter=1,this.width=1e3,this.height=200,this.item_size=10,this.label_padding=40,this.max_block_height=20,this.transition_duration=500,this.in_transition=!1,this.tooltip_width=250,this.tooltip_padding=15,this.history=["year"],this.selected={}}return t.prototype.ngOnChanges=function(){this.data&&(this.updateDataSummary(),this.drawChart())},t.prototype.ngAfterViewInit=function(){var t=this.element.nativeElement
...
return t.summary=n.sort(function(t,e){return e.value-t.value}),t})},t.prototype.drawChart=function(){this.svg&&this.data&&("year"===this.overview?this.drawYearOverview():"month"===this.overview?this.drawMonthOverview():"week"===this.overview?this.drawWeekOverview():"day"===this.overview&&this.drawDayOverview())},t.prototype.drawYearOverview=function(){var t=this
this.history[this.history.length-1]!==this.overview&&this.history.push(this.overview)
var e=d3.max(this.data,function(t){return t.total}),n=d3.scale.linear().range(["#ffffff",this.color]).domain([-.15*e,e])
this.items.selectAll(".item-circle").remove(),this.items.selectAll(".item-circle").data(this.data).enter().append("rect").attr("class","item item-circle").style("opacity",0).attr("x",function(n){return t.calcItemX(n)+(t.item_size-t.calcItemSize(n,e))/2}).attr("y",function(n){return t.calcItemY(n)+(t.item_size-t.calcItemSize(n,e))/2}).attr("rx",function(n){return t.calcItemSize(n,e)}).attr("ry",function(n){return t.calcItemSize(n,e)}).attr("width",function(n){return t.calcItemSize(n,e)}).attr("height",function(n){return t.calcItemSize(n,e)}).attr("fill",function(t){return t.total>0?n(t.total):"transparent"}).on("click",function(e){t.in_transition||0!==e.total&&(t.in_transition=!0,t.selected=e,t.hideTooltip(),t.removeYearOverview(),t.overview="day",t.drawChart())}).on("mouseover",function(n){if(!t.in_transition){var i=d3.select(d3.event.currentTarget),a=function(){i=i.transition().duration(t.transition_duration).ease("ease-in").attr("x",function(e){return t.calcItemX(e)-(1.1*t.item_size-t.item_size)/2}).attr("y",function(e){return t.calcItemY(e)-(1.1*t.item_size-t.item_size)/2}).attr("width",1.1*t.item_size).attr("height",1.1*t.item_size).transition().duration(t.transition_duration).ease("ease-in").attr("x",function(n){return t.calcItemX(n)+(t.item_size-t.calcItemSize(n,e))/2}).attr("y",function(n){return t.calcItemY(n)+(t.item_size-t.calcItemSize(n,e))/2}).attr("width",function(n){return t.calcItemSize(n,e)}).attr("height",function(n){return t.calcItemSize(n,e)}).each("end",a)}
a()
var r=""
...
var o=t.calcItemX(n)+t.item_size
t.width-o<t.tooltip_width+3*t.tooltip_padding&&(o-=t.tooltip_width+2*t.tooltip_padding)
var s=t.calcItemY(n)+t.item_size
t.tooltip.html(r).style("left",o+"px").style("top",s+"px").transition().duration(t.transition_duration/2).ease("ease-in").style("opacity",1)}}).on("mouseout",function(){t.in_transition||(d3.select(d3.event.currentTarget).transition().duration(t.transition_duration/2).ease("ease-in").attr("x",function(n){return t.calcItemX(n)+(t.item_size-t.calcItemSize(n,e))/2}).attr("y",function(n){return t.calcItemY(n)+(t.item_size-t.calcItemSize(n,e))/2}).attr("width",function(n){return t.calcItemSize(n,e)}).attr("height",function(n){return t.calcItemSize(n,e)}),t.hideTooltip())}).transition().delay(function(){return(Math.cos(Math.PI*Math.random())+1)*t.transition_duration}).duration(function(){return t.transition_duration}).ease("ease-in").style("opacity",1).call(function(t,e){t.empty()&&e()
var n=0
t.each(function(){++n}).each("end",function(){--n||e.apply(this,arguments)})},function(){t.in_transition=!1})
var i=moment().endOf("day"),a=moment().startOf("day").subtract(1,"year"),r=d3.time.months(a.startOf("month"),i),o=d3.scale.linear().range([0,this.width]).domain([0,r.length])
this.labels.selectAll(".label-month").remove(),this.labels.selectAll(".label-month").data(r).enter().append("text").attr("class","label label-month").attr("font-size",function(){return Math.floor(t.label_padding/3)+"px"}).text(function(t){return t.toLocaleDateString("en-us",{month:"short"})}).attr("x",function(t,e){return o(e)+(o(e)-o(e-1))/2}).attr("y",this.label_padding/2).on("mouseenter",function(e){if(!t.in_transition){var n=moment(e)
...
var s=d3.time.days(moment().startOf("week"),moment().endOf("week")),l=d3.scale.ordinal().rangeRoundBands([this.label_padding,this.height]).domain(s.map(function(t){return moment(t).weekday()}))
this.labels.selectAll(".label-day").remove(),this.labels.selectAll(".label-day").data(s).enter().append("text").attr("class","label label-day").attr("x",this.label_padding/3).attr("y",function(t,e){return l(e)+l.rangeBand()/1.75}).style("text-anchor","left").attr("font-size",function(){return Math.floor(t.label_padding/3)+"px"}).text(function(t){return moment(t).format("dddd")[0]}).on("mouseenter",function(e){if(!t.in_transition){var n=moment(e)
t.items.selectAll(".item-circle").transition().duration(t.transition_duration).ease("ease-in").style("opacity",function(t){return moment(t.date).day()===n.day()?1:.1})}}).on("mouseout",function(){t.in_transition||t.items.selectAll(".item-circle").transition().duration(t.transition_duration).ease("ease-in").style("opacity",1)})},t.prototype.drawMonthOverview=function(){var t=this
this.history[this.history.length-1]!==this.overview&&this.history.push(this.overview)
for(var e=moment(this.selected.date).startOf("month"),n=moment(this.selected.date).endOf("month"),i=this.data.filter(function(t){return e<=moment(t.date)&&moment(t.date)<n}),a=d3.max(i,function(t){return d3.max(t.summary,function(t){return t.value})}),r=d3.time.days(moment().startOf("week"),moment().endOf("week")),o=d3.scale.ordinal().rangeRoundBands([this.label_padding,this.height]).domain(r.map(function(t){return moment(t).weekday()})),s=[e.clone()];e.week()!==n.week();)s.push(e.add(1,"week").clone())
...
var d=this.items.selectAll(".item-block-month").data(i).enter().append("g").attr("class","item item-block-month").attr("width",function(){return(t.width-t.label_padding)/s.length-5*t.gutter}).attr("height",function(){return Math.min(o.rangeBand(),t.max_block_height)}).attr("transform",function(t){return"translate("+l(moment(t.date).week())+","+(o(moment(t.date).weekday())+o.rangeBand()/1.75-15)+")"}).attr("total",function(t){return t.total}).attr("date",function(t){return t.date}).attr("offset",0).on("click",function(e){t.in_transition||0!==e.total&&(t.in_transition=!0,t.selected=e,t.hideTooltip(),t.removeMonthOverview(),t.overview="day",t.drawChart())}),c=(this.width-this.label_padding)/s.length-5*this.gutter,u=d3.scale.linear().rangeRound([0,c]),m=this.item_gutter
...
return u.domain([0,e]),Math.max(u(t.value)-m,1)}).attr("height",function(){return Math.min(o.rangeBand(),t.max_block_height)}).attr("fill",function(e){return d3.scale.linear().range(["#ffffff",t.color]).domain([-.15*a,a])(e.value)||"#ff4500"}).style("opacity",0).on("mouseover",function(e){if(!t.in_transition){var n=new Date(d3.select(d3.event.currentTarget.parentNode).attr("date")),i=""
...
this.history[this.history.length-1]!==this.overview&&this.history.push(this.overview)
var e=moment(this.selected.date).startOf("week"),n=moment(this.selected.date).endOf("week"),i=this.data.filter(function(t){return e<=moment(t.date)&&moment(t.date)<n}),a=d3.max(i,function(t){return d3.max(t.summary,function(t){return t.value})}),r=d3.time.days(moment().startOf("week"),moment().endOf("week")),o=d3.scale.ordinal().rangeRoundBands([this.label_padding,this.height]).domain(r.map(function(t){return moment(t).weekday()})),s=[e],l=d3.scale.ordinal().rangeRoundBands([this.label_padding,this.width],.01).domain(s.map(function(t){return t.week()}))
...
u.domain([0,a])
for(var r=parseInt(d3.select(d3.event.currentTarget).attr("x"))+u(e.value)/4+t.tooltip_width/4;t.width-r<t.tooltip_width+3*t.tooltip_padding;)r-=10
var s=o(moment(n).weekday())+1.5*t.tooltip_padding
t.tooltip.html(i).style("left",r+"px").style("top",s+"px").transition().duration(t.transition_duration/2).ease("ease-in").style("opacity",1)}}).on("mouseout",function(){t.in_transition||t.hideTooltip()}).transition().delay(function(){return(Math.cos(Math.PI*Math.random())+1)*t.transition_duration}).duration(function(){return t.transition_duration}).ease("ease-in").style("opacity",1).call(function(t,e){t.empty()&&e()
var n=0
...
for(var r=100*e.value/86400+i(moment(e.date));t.width-r<t.tooltip_width+3*t.tooltip_padding;)r-=10
var o=n(e.name)+n.rangeBand()/2+t.tooltip_padding/2
t.tooltip.html(a).style("left",r+"px").style("top",o+"px").transition().duration(t.transition_duration/2).ease("ease-in").style("opacity",1)}}).on("mouseout",function(){t.in_transition||t.hideTooltip()}).on("click",function(e){t.handler&&t.handler.emit(e)}).transition().delay(function(){return(Math.cos(Math.PI*Math.random())+1)*t.transition_duration}).duration(function(){return t.transition_duration}).ease("ease-in").style("opacity",.5).call(function(t,e){t.empty()&&e()
var n=0
t.each(function(){++n}).each("end",function(){--n||e.apply(this,arguments)})},function(){t.in_transition=!1})
var a=d3.time.hours(moment(this.selected.date).startOf("day"),moment(this.selected.date).endOf("day")),r=d3.time.scale().range([2*this.label_padding,this.width]).domain([0,a.length])
this.labels.selectAll(".label-time").remove(),this.labels.selectAll(".label-time").data(a).enter().append("text").attr("class","label label-time").attr("font-size",function(){return Math.floor(t.label_padding/3)+"px"}).text(function(t){return moment(t).format("HH:mm")}).attr("x",function(t,e){return r(e)}).attr("y",this.label_padding/2).on("mouseenter",function(e){if(!t.in_transition){var n=i(moment(e))
...
var e=this.buttons.append("g").attr("class","button button-back").style("opacity",0).on("click",function(){t.in_transition||(t.in_transition=!0,"month"===t.overview?t.removeMonthOverview():"week"===t.overview?t.removeWeekOverview():"day"===t.overview&&t.removeDayOverview(),t.history.pop(),t.overview=t.history.pop(),t.drawChart())})
e.append("circle").attr("cx",this.label_padding/2.25).attr("cy",this.label_padding/2.5).attr("r",this.item_size/2),e.append("text").attr("x",this.label_padding/2.25).attr("y",this.label_padding/2.75).attr("dy",function(){return Math.floor(t.width/100)/2.5}).attr("font-size",function(){return Math.floor(t.label_padding/3)+"px"}).html("&#x2190;"),e.transition().duration(this.transition_duration).ease("ease-in").style("opacity",1)},t.prototype.removeYearOverview=function(){this.items.selectAll(".item-circle").transition().duration(this.transition_duration).ease("ease").style("opacity",0).remove(),this.labels.selectAll(".label-day").remove(),this.labels.selectAll(".label-month").remove()},t.prototype.removeMonthOverview=function(){var t=this
