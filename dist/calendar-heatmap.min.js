...
return t},{})
return Object.keys(t).map(function(e){return{name:e,value:t[e].value}}).sort(function(t,e){return e.value-t.value})}()}}),r=d3.max(a,function(t){return t.total}),o=d3.time.years(e,n).map(function(t){return moment(t)}),s=d3.scale.ordinal().rangeRoundBands([0,this.width],.05).domain(o.map(function(t){return t.year()}))
this.items.selectAll(".item-block-year").remove()
this.items.selectAll(".item-block-year").data(a).enter().append("rect").attr("class","item item-block-year").attr("width",function(){return(t.width-t.label_padding)/o.length-5*t.gutter}).attr("height",function(){return t.height-t.label_padding}).attr("transform",function(e){return"translate("+s(e.date.year())+","+2*t.tooltip_padding+")"}).attr("fill",function(e){return d3.scale.linear().range(["#ffffff",t.color||"#ff4500"]).domain([-.15*r,r])(e.total)||"#ff4500"}).on("click",function(e){t.in_transition||(t.in_transition=!0,t.selected=e,t.hideTooltip(),t.removeGlobalOverview(),t.overview="year",t.drawChart())}).style("opacity",0).on("mouseover",function(e){if(!t.in_transition){var n=""
n+="<div><span><strong>Total time tracked:</strong></span>"
var i=parseInt(e.total,10),a=Math.floor(i/86400)
a>0&&(n+="<span>"+(1===a?"1 day":a+" days")+"</span></div>")
var r=Math.floor((i-86400*a)/3600)
r>0&&(n+=a>0?"<div><span></span><span>"+(1===r?"1 hour":r+" hours")+"</span></div>":"<span>"+(1===r?"1 hour":r+" hours")+"</span></div>")
var o=Math.floor((i-86400*a-3600*r)/60)
if(o>0&&(n+=a>0||r>0?"<div><span></span><span>"+(1===o?"1 minute":o+" minutes")+"</span></div>":"<span>"+(1===o?"1 minute":o+" minutes")+"</span></div>"),n+="<br />",e.summary.length<=5)for(var l=0;l<e.summary.length;l++)n+="<div><span><strong>"+e.summary[l].name+"</strong></span>",n+="<span>"+t.formatTime(e.summary[l].value)+"</span></div>"
else{for(var l=0;l<5;l++)n+="<div><span><strong>"+e.summary[l].name+"</strong></span>",n+="<span>"+t.formatTime(e.summary[l].value)+"</span></div>"
n+="<br />"
for(var d=0,l=5;l<e.summary.length;l++)d=+e.summary[l].value
n+="<div><span><strong>Other:</strong></span>",n+="<span>"+t.formatTime(d)+"</span></div>"}for(var c=s(e.date.year())+2*t.tooltip_padding;t.width-c<t.tooltip_width+5*t.tooltip_padding;)c-=10
var u=3*t.tooltip_padding
t.tooltip.html(n).style("left",c+"px").style("top",u+"px").transition().duration(t.transition_duration/2).ease("ease-in").style("opacity",1)}}).on("mouseout",function(){t.in_transition||t.hideTooltip()}).transition().delay(function(e,n){return t.transition_duration*(n+1)/10}).duration(function(){return t.transition_duration}).ease("ease-in").style("opacity",1).call(function(t,e){t.empty()&&e()
var n=0
t.each(function(){++n}).each("end",function(){--n||e.apply(this,arguments)})},function(){t.in_transition=!1})
this.labels.selectAll(".label-year").remove(),this.labels.selectAll(".label-year").data(o).enter().append("text").attr("class","label label-year").attr("font-size",function(){return Math.floor(t.label_padding/3)+"px"}).text(function(t){return t.year()}).attr("x",function(t){return s(t.year())}).attr("y",this.label_padding/2).on("mouseenter",function(e){t.in_transition||t.items.selectAll(".item-block-year").transition().duration(t.transition_duration).ease("ease-in").style("opacity",function(t){return moment(t.date).year()===e.year()?1:.1})}).on("mouseout",function(){t.in_transition||t.items.selectAll(".item-block-year").transition().duration(t.transition_duration).ease("ease-in").style("opacity",1)}).on("click",function(e){t.in_transition||(t.in_transition=!0,t.selected=e,t.hideTooltip(),t.removeGlobalOverview(),t.overview="year",t.drawChart())})},t.prototype.drawYearOverview=function(){var t=this
this.history[this.history.length-1]!==this.overview&&this.history.push(this.overview)
var e=moment(this.selected.date).startOf("year"),n=moment(this.selected.date).endOf("year"),i=this.data.filter(function(t){return e<=moment(t.date)&&moment(t.date)<n}),a=d3.max(i,function(t){return t.total}),r=d3.scale.linear().range(["#ffffff",this.color]).domain([-.15*a,a])
this.items.selectAll(".item-circle").remove(),this.items.selectAll(".item-circle").data(i).enter().append("rect").attr("class","item item-circle").style("opacity",0).attr("x",function(n){return t.calcItemX(n,e)+(t.item_size-t.calcItemSize(n,a))/2}).attr("y",function(e){return t.calcItemY(e)+(t.item_size-t.calcItemSize(e,a))/2}).attr("rx",function(e){return t.calcItemSize(e,a)}).attr("ry",function(e){return t.calcItemSize(e,a)}).attr("width",function(e){return t.calcItemSize(e,a)}).attr("height",function(e){return t.calcItemSize(e,a)}).attr("fill",function(t){return t.total>0?r(t.total):"transparent"}).on("click",function(e){t.in_transition||0!==e.total&&(t.in_transition=!0,t.selected=e,t.hideTooltip(),t.removeYearOverview(),t.overview="day",t.drawChart())}).on("mouseover",function(n){if(!t.in_transition){var i=d3.select(d3.event.currentTarget),r=function(){i=i.transition().duration(t.transition_duration).ease("ease-in").attr("x",function(n){return t.calcItemX(n,e)-(1.1*t.item_size-t.item_size)/2}).attr("y",function(e){return t.calcItemY(e)-(1.1*t.item_size-t.item_size)/2}).attr("width",1.1*t.item_size).attr("height",1.1*t.item_size).transition().duration(t.transition_duration).ease("ease-in").attr("x",function(n){return t.calcItemX(n,e)+(t.item_size-t.calcItemSize(n,a))/2}).attr("y",function(e){return t.calcItemY(e)+(t.item_size-t.calcItemSize(e,a))/2}).attr("width",function(e){return t.calcItemSize(e,a)}).attr("height",function(e){return t.calcItemSize(e,a)}).each("end",r)}
r()
var o=""
o+='<div class="header"><strong>'+(n.total?t.formatTime(n.total):"No time")+" tracked</strong></div>",o+="<div>on "+moment(n.date).format("dddd, MMM Do YYYY")+"</div><br>",n.summary.map(function(e){o+="<div><span><strong>"+e.name+"</strong></span>",o+="<span>"+t.formatTime(e.value)+"</span></div>"})
